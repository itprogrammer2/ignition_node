...
! function(a) {
    ...
    b.prototype = {
        ...
        scope: null,
        savenochange: !1
    }, a.fn.editableform.template = '<form class="form-inline editableform">\
                                    ...
                                    </form>', a.fn.editableform.loading = '<div class="editableform-loading"></div>'
                                            , a.fn.editableform.buttons = '<button type="submit" class="editable-submit">ok</button>\
...
function(a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {
        render: function() {
            this.setClass(), this.setAttr("placeholder"), this.setAttr("rows"), this.setAttr("cols"), this.$input.keydown(function(b) {
...
function(a) {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {
            ...
            ~a.inArray(this.input.type, e) && (this.input.$input.addClass("form-controlx"), c && (this.input.options.inputclass = d, this.input.$input.addClass(d)));
            for (var f = this.$form.find(".editable-buttons"), g = c ? [d] : this.input.options.inputclass.split(" "), h = 0; h < g.length; h++) "input-lg" === g[h].toLowerCase() && f.find("button").removeClass("btn-sm").addClass("btn-lg")
    ...
    }), a.fn.editableform.buttons = '<div style="height:30px;">\
                                    ...
                                    </div>', a.fn.editableform.errorGroupClass = "has-error"
